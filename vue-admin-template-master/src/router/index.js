...
export const constantRouterMap = [
    ...
    children: [
      {
        path: 'list',
        name: '医院设置',
        component: () => import('@/views/hosp/hospset/list'),
        meta: { title: '医院设置', icon: 'table' }
      },
      {
        path: 'add',
        name: '医院添加',
        component: () => import('@/views/hosp/hospset/add'),
    ...
    children: [
      {
        path: 'list',
        name: '数据字典',
        component: () => import('@/views/cmn/index'),
  ...
  
  {
    ...
    name: '身份信息管理',
    meta: { title: '身份信息管理', icon: 'example' },
    children: [
      {
        path: 'list',
        name: '身份设置',
        component: () => import('@/views/person/list'),
        meta: { title: '身份设置', icon: 'table' }
      },
      {
        path: 'add',
        name: '身份添加',
        component: () => import('@/views/person/add'),
        meta: { title: '身份添加', icon: 'tree' }
      },
      {
        path: 'edit/:id',
        name: '身份编辑',
        component: () => import('@/views/person/add'),
        meta: { title: '身份编辑', icon: 'tree' },
        hidden: true
      }
    ]
  },
